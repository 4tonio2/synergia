    ...
    try {
      ...
      mediaRecorder.onstop = async () => {
        ...
        try {
          ...
          let prefix = '';
          if (currentRecordingType === 'crm') prefix = '[CRM] ';
          ...
          if (currentRecordingType === 'prescription') {
            ...
            try {
              ...
              if (webhookResponse.ok) {
                ...
                console.error('[WEBHOOK] Erreur réponse:', errorText);
        ...
        <div className="w-full max-w-md space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3 w-full">
                ...
                <div className="flex flex-col items-center">
                  <button
                    ...
                    className={`w-full py-3 px-4 text-white font-semibold rounded-xl shadow-md transition-all duration-200 flex items-center justify-center gap-2 ${isRecording && recordingType === 'crm'
          ...
          <div className="bg-white rounded-2xl shadow-sm p-4 space-y-3">
            ...
            <Button
              ...
              disabled={isPreparingAgenda || !formData.notesRaw}
              variant="outline"
              className="w-full h-12 rounded-full bg-gradient-to-r from-indigo-50 to-purple-50 border-indigo-200 hover:border-indigo-400"
            >
              {isPreparingAgenda ? (
                <>
                  <Loader2 className="w-5 h-5 mr-2 animate-spin" />
